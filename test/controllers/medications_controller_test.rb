...
class MedicationsControllerTest < ActionController::TestCase
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post :create, medication: { description: @medication.description, name: @medication.name, specialNotes: @medication.specialNotes, user_id: @medication.user_id }
    end
  ...
  test "should update medication" do
    patch :update, id: @medication, medication: { description: @medication.description, name: @medication.name, specialNotes: @medication.specialNotes, user_id: @medication.user_id }
    assert_redirected_to medication_path(assigns(:medication))
  end
